...
with st.form("user_input_form"):
    ...
    numwebp = st.slider("NumCatalogPurchases - number of purchases made using catalogue", min_value=0, max_value=30)
    numcatp = st.slider("NumStorePurchases - number of purchases made directly in stores", min_value=0, max_value=30)
